...
class WindowsMsnLiveLogin
  ...
  #####################################################################
  # Initialize the WindowsMsnLiveLogin module with the application ID,
  ...
  #####################################################################
  # Initialize the WindowsMsnLiveLogin module from a settings file.
  #
  ...
  #
  # We recommend that you store the WindowsMsnLiveLogin settings file
  ...
  #####################################################################
  def self.from_xml(settingsFile)
    from_hash( parseSettings(settingsFile) )
  end

  def self.from_hash( settings )
    o = self.new
...
class WindowsMsnLiveLogin
  ...
  class ConsentToken
    ...
    #####################################################################
    # Initialize the ConsentToken module with the WindowsMsnLiveLogin,
    ...
    #####################################################################
    # Returns the CID for this Consent Token
    #####################################################################
    def cid
      convert_to_signed(locationid.to_i(16))
    end
    ...
    #####################################################################
    # Converts a unsigned Numeric into a signed Numeric.
    #####################################################################
...
class WindowsMsnLiveLogin
  ...
  #######################################################################
  def self.parseSettings(settingsFile)
    settings = {}
    begin
