module Paperclip
  ...
  class Attachment
    ...
    def self.default_options
      @default_options ||= {
        :url           => "/system/:attachment/:hoodiny_partition/:style/:basename.:extension",
        :path          => ":rails_root/public/system/:attachment/:hoodiny_partition/:style/:basename.:extension",
        :styles        => {},
    ...
    def self.interpolations
      @interpolations ||= {
        ...
        :hoodiny_partition => lambda do |attachment, style|
                           PartitionedPath.path_for(attachment.instance.id).join("/")
                         end,
      }
    end
